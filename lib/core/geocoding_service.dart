...
import 'package:staffsync/core/route_model.dart';
...
class GeocodingService {
  ...
  Future<LocationModel> _reverseGeocodeOlaMaps(double lat, double lon, {int retries = 3,
      }) async {
    final url = 'https://api.olamaps.io/places/v1/reverse-geocode?latlng=$lat,$lon&api_key=${AppConstants.olaApiKey}';
